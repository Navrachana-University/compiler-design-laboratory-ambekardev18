...
{
      18,     0,    -1,    19,    -1,    -1,    19,    20,    -1,     6,
      21,    11,    -1,     4,    12,    21,    11,    -1,     5,    13,
      21,    14,    15,    19,    16,    -1,     3,    -1,     4,    -1,
      21,     7,    21,    -1,    21,     8,    21,    -1,    21,     9,
      21,    -1,    21,    10,    21,    -1,    13,    21,    14,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    64,    64,    67,    69,    73,    76,    80,   101,   102,
     103,   104,   105,   106,   114
};
#endif
...
{
  "$end", "error", "$undefined", "INTEGER", "IDENTIFIER", "WHILE",
  "PRINT", "'+'", "'-'", "'*'", "'/'", "';'", "'='", "'('", "')'", "'{'",
...
{
     -14,     8,    26,   -14,     3,     9,    10,   -14,    10,    10,
     -14,   -14,    10,    27,    32,    11,    19,    10,    10,    10,
      10,   -14,   -14,    29,   -14,    -7,    -7,   -14,   -14,   -14,
       1,   -14
};
...
{
      14,    15,    19,    20,    16,     4,     5,     6,     3,    25,
      26,    27,    28,    10,    11,     8,    30,    31,    17,    18,
      19,    20,     9,    12,     0,    23,    17,    18,    19,    20,
       4,     5,     6,    24,    17,    18,    19,    20,    21,    17,
      18,    19,    20,    22,    29
};

static const yytype_int8 yycheck[] =
{
       8,     9,     9,    10,    12,     4,     5,     6,     0,    17,
      18,    19,    20,     3,     4,    12,    29,    16,     7,     8,
       9,    10,    13,    13,    -1,    14,     7,     8,     9,    10,
       4,     5,     6,    14,     7,     8,     9,    10,    11,     7,
       8,     9,    10,    11,    15
};
...
{
       0,    18,    19,     0,     4,     5,     6,    20,    12,    13,
       3,     4,    13,    21,    21,    21,    21,     7,     8,     9,
      10,    11,    11,    14,    14,    21,    21,    21,    21,    15,
      19,    16
};
...
#line 76 "parser.y"
    {
        set_value((yyvsp[(1) - (4)].sval), (yyvsp[(3) - (4)].ival));
        free((yyvsp[(1) - (4)].sval));
    ;}
    break;
...
#line 101 "parser.y"
  ...
  case 9:
#line 102 "parser.y"
    { (yyval.ival) = get_value((yyvsp[(1) - (1)].sval)); free((yyvsp[(1) - (1)].sval)); ;}
    break;
